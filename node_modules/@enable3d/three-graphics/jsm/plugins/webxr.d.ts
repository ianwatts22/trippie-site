 ...
 */
import { BufferGeometry, Group, Line, LineBasicMaterial, Mesh, MeshBasicMaterial, Scene, Vector3, WebGLRenderer } from 'three';
...
export default class WebXR {
    ...
    getControllerRay(data: any): Line<BufferGeometry, LineBasicMaterial> | Mesh<BufferGeometry, MeshBasicMaterial> | undefined;
    get camera(): {
        group: Group;
        position: Vector3;
